...
doctor:
    @echo "Running diagnostics for LowLevel.jl..."
...
help-me:
    @echo "=== LowLevel.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/LowLevel.jl/issues/new"
    @echo ""
